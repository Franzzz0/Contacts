...
abstract class Phone {
    ...
    public Phone(PhoneDetailsFactory detailsFactory) {
        this.camera = detailsFactory.createCamera();
        this.display = detailsFactory.createDisplay();
        this.processor = detailsFactory.createProcessor();
        this.security = detailsFactory.createSecurity();
    }
...
class Iphone extends Phone {
    ...
    public Iphone(PhoneDetailsFactory detailsFactory) {
...
class Samsung extends Phone {
    ...
    public Samsung(PhoneDetailsFactory detailsFactory) {
        super(detailsFactory);
    }
